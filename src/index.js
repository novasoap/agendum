...
import {MDBBtn, MDBCloseIcon, MDBInput, MDBModal, MDBModalBody, MDBModalHeader, MDBModalFooter, MDBIcon, MDBContainer, MDBRow, MDBCol} from "mdbreact";
import "./index.css";
            ...
            <React.Fragment>
                <div className="rounded">
                    <div className="media mt-1">
                        <h3 className="h3-responsive font-weight-bold mr-5">
                            {this.state.time}
                        </h3>
